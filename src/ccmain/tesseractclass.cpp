...
Tesseract::Tesseract()
    : BOOL_MEMBER(tessedit_resegment_from_boxes, false,
      ...
      BOOL_MEMBER(hocr_font_info, false, "Add font info to hocr output",
                  this->params()),
      BOOL_MEMBER(abbyy_font_info, false, "Add font info to abbyy output",
                  this->params()),
      BOOL_MEMBER(abbyy_debug, false, "Debug abbyy-style output",
                  this->params()),
      BOOL_MEMBER(hocr_char_boxes, false, "Add coordinates for each character to hocr output",
                  this->params()),
      BOOL_MEMBER(abbyy_char_boxes, false, "Add coordinates for each character to abbyy output",
                  this->params()),
      ...
      BOOL_MEMBER(tessedit_create_alto, false, "Write .xml ALTO file",
                  this->params()),
      BOOL_MEMBER(tessedit_create_abbyy, false, "Write .xml ABBYY-style file",
                  this->params()),
